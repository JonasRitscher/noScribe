...
class MainWindow(QtWidgets.QMainWindow):
    ...
    def __init__(self, *args, **kwargs):
        ...
        file_menu = self.menuBar().addMenu(t('editor.menu.file'))

        open_file_action = QtGui.QAction(qta.icon('mdi.folder-open', color=icon_color), t('editor.menu.open_file'), self)
        open_file_action.setStatusTip(t('editor.tooltip.open_file'))
        open_file_action.setShortcut(QtGui.QKeySequence.Open)
        open_file_action.triggered.connect(self.file_open)
        file_menu.addAction(open_file_action)
        file_toolbar.addAction(open_file_action)
        
        self.recent_files_menu = file_menu.addMenu(t('editor.menu.recent_files'))
        self.update_recent_files_menu()  # Populate the recent files submenu initially

        save_file_action = QtGui.QAction(qta.icon('mdi.content-save', color=icon_color), t('editor.menu.save'), self)
        save_file_action.setStatusTip(t('editor.tooltip.save'))
        save_file_action.setShortcut(QtGui.QKeySequence.Save)
        save_file_action.triggered.connect(self.file_save)
        file_menu.addAction(save_file_action)
        file_toolbar.addAction(save_file_action)

        saveas_file_action = QtGui.QAction(qta.icon('mdi.content-save-move', color=icon_color), t('editor.menu.save_as'), self)
        saveas_file_action.setStatusTip(t('editor.tooltip.save_as'))
        ...
        audio_source_action = QtGui.QAction(qta.icon('mdi.waveform', color=icon_color), t('editor.menu.audio_source'), self)
        audio_source_action.setStatusTip(t('editor.tooltip.audio_source'))
        audio_source_action.triggered.connect(self.open_audio_source)
        file_menu.addAction(audio_source_action)


        noScribe_toolbar = QtWidgets.QToolBar(t('editor.menu.noScribe'))
        ...
        self.play_along_action = QtGui.QAction(qta.icon('mdi.volume-high', color=highlight_color), t('editor.action.play_pause'), self)      
        self.play_along_action.setCheckable(True)
        self.play_along_action.setStatusTip(t('editor.tooltip.play_pause'))
        ...
        undo_action.setStatusTip(t('editor.tooltip.undo'))
        undo_action.setShortcut(QtGui.QKeySequence.Undo)
        undo_action.triggered.connect(self.editor.undo)
        edit_toolbar.addAction(undo_action)
        edit_menu.addAction(undo_action)

        redo_action = QtGui.QAction(qta.icon('mdi.redo', color=icon_color), t('editor.action.redo'), self)
        redo_action.setStatusTip(t('editor.tooltip.redo'))
        ...
        cut_action = QtGui.QAction(qta.icon('mdi.content-cut', color=icon_color), t('editor.action.cut'), self)
        cut_action.setStatusTip(t('editor.tooltip.cut'))
        cut_action.setShortcut(QtGui.QKeySequence.Cut)
        cut_action.triggered.connect(self.editor.cut)
        edit_toolbar.addAction(cut_action)
        edit_menu.addAction(cut_action)

        copy_action = QtGui.QAction(qta.icon('mdi.content-copy', color=icon_color), t('editor.action.copy'), self)
        copy_action.setStatusTip(t('editor.tooltip.copy'))
        copy_action.setShortcut(QtGui.QKeySequence.Copy)
        copy_action.triggered.connect(self.editor.copy)
        edit_toolbar.addAction(copy_action)
        edit_menu.addAction(copy_action)

        paste_action = QtGui.QAction(qta.icon('mdi.content-paste', color=icon_color), t('editor.action.paste'), self)
        paste_action.setStatusTip(t('editor.tooltip.paste'))
        paste_action.setShortcut(QtGui.QKeySequence.Paste)
        paste_action.triggered.connect(self.editor.paste)
        edit_toolbar.addAction(paste_action)
        edit_menu.addAction(paste_action)

        select_action = QtGui.QAction(t('editor.action.select_all'), self)
        select_action.setStatusTip(t('editor.tooltip.select_all'))
        ...
        find_action = QtGui.QAction(qta.icon('mdi.magnify', color=icon_color), t('editor.action.find_replace'), self)
        find_action.setStatusTip(t('editor.tooltip.find_replace'))
        find_action.setToolTip(t('editor.tooltip.find_replace'))
        ...
        zoomIn_action = QtGui.QAction(qta.icon('mdi.plus-circle-outline', color=icon_color), t('editor.action.zoom_in'), self)
        zoomIn_action.setStatusTip(t('editor.action.zoom_in'))
        ...
        zoomOut_action = QtGui.QAction(qta.icon('mdi.minus-circle-outline', color=icon_color), t('editor.action.zoom_out'), self)
        zoomOut_action.setStatusTip(t('editor.action.zoom_out'))
        ...
        # Generated by Antigravity AI to allow interactive line spacing adjustments.
        self.spacingIn_action = QtGui.QAction(qta.icon('mdi.arrow-expand-vertical', color=icon_color), t('editor.action.line_spacing_increase'), self)
        self.spacingIn_action.setStatusTip("Increase line spacing")
        self.spacingIn_action.triggered.connect(self.increase_line_spacing)
        edit_toolbar.addAction(self.spacingIn_action)
        edit_menu.addAction(self.spacingIn_action)

        self.spacingOut_action = QtGui.QAction(qta.icon('mdi.arrow-collapse-vertical', color=icon_color), t('editor.action.line_spacing_decrease'), self)
        self.spacingOut_action.setStatusTip("Decrease line spacing")
        self.spacingOut_action.triggered.connect(self.decrease_line_spacing)
        edit_toolbar.addAction(self.spacingOut_action)
        edit_menu.addAction(self.spacingOut_action)

        format_toolbar = QtWidgets.QToolBar(t('editor.menu.format'))
        ...
        format_menu = self.menuBar().addMenu(t('editor.menu.format'))

        # We need references to these actions/settings to update as selection changes, so attach to self.
        self.bold_action = QtGui.QAction(qta.icon('mdi.format-bold', color=icon_color), t('editor.action.bold'), self)
        self.bold_action.setStatusTip(t('editor.action.bold'))
        ...
        self.italic_action = QtGui.QAction(qta.icon('mdi.format-italic', color=icon_color), t('editor.action.italic'), self)
        self.italic_action.setStatusTip(t('editor.action.italic'))
        ...
        self.underline_action = QtGui.QAction(qta.icon('mdi.format-underline', color=icon_color), t('editor.action.underline'), self)
        self.underline_action.setStatusTip(t('editor.action.underline'))
        ...
        self.alignl_action = QtGui.QAction(qta.icon('mdi.format-align-left', color=icon_color), t('editor.action.align_left'), self)
        self.alignl_action.setStatusTip(t('editor.tooltip.align_left'))
        self.alignl_action.setCheckable(True)
        self.alignl_action.triggered.connect(lambda: self.editor.setAlignment(QtCore.Qt.AlignLeft))
        format_toolbar.addAction(self.alignl_action)
        format_menu.addAction(self.alignl_action)

        self.alignc_action = QtGui.QAction(qta.icon('mdi.format-align-center', color=icon_color), t('editor.action.align_center'), self)
        self.alignc_action.setStatusTip(t('editor.tooltip.align_center'))
        self.alignc_action.setCheckable(True)
        self.alignc_action.triggered.connect(lambda: self.editor.setAlignment(QtCore.Qt.AlignCenter))
        format_toolbar.addAction(self.alignc_action)
        format_menu.addAction(self.alignc_action)

        self.alignr_action = QtGui.QAction(qta.icon('mdi.format-align-right', color=icon_color), t('editor.action.align_right'), self)
        self.alignr_action.setStatusTip(t('editor.tooltip.align_right'))
        self.alignr_action.setCheckable(True)
        self.alignr_action.triggered.connect(lambda: self.editor.setAlignment(QtCore.Qt.AlignRight))
        format_toolbar.addAction(self.alignr_action)
        format_menu.addAction(self.alignr_action)

        self.alignj_action = QtGui.QAction(qta.icon('mdi.format-align-justify', color=icon_color), t('editor.action.justify'), self)
        self.alignj_action.setStatusTip(t('editor.tooltip.justify'))
    ...
    def _file_open(self, path):
        try:
            ...
            self.tmp_audio_file = None
            self.status.showMessage(t('editor.msg.loading'))
            ...
            self.editor.setText(t('editor.msg.loading'))
    ...
    def decrease_line_spacing(self):
        spacing = int(get_config('editor_line_spacing', '100'))
        spacing -= 10
        if spacing < 100: spacing = 100 # Standardabstand ist das Minimum
        config['editor_line_spacing'] = str(spacing)
        self.apply_line_spacing()
