...
class SearchAndReplaceDialog(QtWidgets.QDialog):
    ...
    def __init__(self, parent):
        ...
        self.setWindowTitle(t('editor.dialog.find_replace_title'))

        self.layout = QtWidgets.QVBoxLayout(self)

        # Input fields
        self.search_label = QtWidgets.QLabel(t('editor.dialog.find_label'))
        self.replace_label = QtWidgets.QLabel(t('editor.dialog.replace_label'))

        self.search_input = QtWidgets.QLineEdit()
        self.replace_input = QtWidgets.QLineEdit()

        # Options
        self.case_sensitive_checkbox = QtWidgets.QCheckBox(t('editor.dialog.case_sensitive'))
        self.whole_word_checkbox = QtWidgets.QCheckBox(t('editor.dialog.whole_word'))

        # Buttons
        self.find_button = QtWidgets.QPushButton(t('editor.dialog.find_next'))
        self.replace_button = QtWidgets.QPushButton(t('editor.dialog.replace'))
        self.replace_all_button = QtWidgets.QPushButton(t('editor.dialog.replace_all'))
        self.close_button = QtWidgets.QPushButton(t('editor.dialog.close'))
